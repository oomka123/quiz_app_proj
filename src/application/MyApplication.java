...
public class MyApplication {
    ...
    public MyApplication(IAuthController authController, IQuizController quizController, IQuestionController questionController, IAnswerController answerController) {
